...
* TODO Org packages
This section sets up all my Org-mode based packages. First I'm defining some directories that I use for all my Org files.

#+begin_src elisp
  (defvar my/roam-directory "~/Documents/Org/RoamNodes"
...
TODO move into an agenda use package
