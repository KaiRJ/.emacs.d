...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-x s") 'hydra-sync-git/body)
#+end_src
...
#+end_src
** eglot
The main benefit of using Language Server Protocol (LSP) to configure the management of your programming languages is that LSP servers are also used by other text editors, increasing contributions to these packages. I am using [[https://www.gnu.org/software/emacs/manual/html_mono/eglot.html][eglot]] as it is built into Emacs and is light weight.
