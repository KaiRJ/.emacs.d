...
- [[#buffer-packages][Buffer packages]]
  ...
  - [[#avy][Avy]]
  - [[#focus-on-new-windows][Focus on new windows]]
  - [[#scrolling][Scrolling]]
- [[#editing][Editing]]
...
#+begin_src emacs-lisp
  (use-package ibuffer
    ...
    :hook (ibuffer . kai/ibuffer-apply-filter-groups)
    :custom
...
#+begin_src emacs-lisp
  ...
  (defun kai/ibuffer-apply-filter-groups ()
...
** TODO Treemacs
I am disabling this for now as I never use it.
...
** TODO Avy
TODO Add link. And this to consult keybindings
...
#+end_src
** TODO Focus on new windows
TODO move this into own functions? not sure if should collected all my elisp into one place or have it next to the stuff they relate to
...
TODO: dont think some of these should be here

** TODO drag-stuff
TODO this are all currently blocked on pop os
