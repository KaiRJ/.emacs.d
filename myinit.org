...
* TODO Buffer packages
This section contains some packages that make navigating between and around buffers and files easier.

** TODO ibuffer
TODO I think this could be structured better (such as moving the function to the top). And making it possible to switch between the two.
The =ibuffer= built-in package provides better buffer management over =buffer-menu=, with a nicer visual interface and syntax colour.
...
#+end_src
** TODO yasnippet
TODO: expand intro with some links. could add a keybinding for ivy (is there a consult version?)
TODO To make editting a coding easier.
...
#+end_src
** TODO undo-tree
TODO check the minimal emacs for this - as feel it should be there and set up a bunch of this
...
When get onto this could be a great opportunity to finally learn orgmode, org agenda and org roam
