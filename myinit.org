...
#+begin_src emacs-lisp
  ...
  (keymap-global-set "<f5>" 'my/compile-build)
  (keymap-global-set "<f6>" 'my/compile-clean)
#+end_src
** Kill buff
...
#+begin_src emacs-lisp
  ;; TODO expand these to other packages and points that use paths
...
** TODO Org-Roam
Based on [[https://jethrokuan.github.io/org-roam-guide/][this]].
and https://www.riccardopinosio.com/blog/posts/zotero_notes_article.html#citar

could move a lot of this to own section for roam stuff
and different one for agenda stuff
