...
*** TODO citar
TODO make sure understand the functions im defining and rename them
TODO test if can move all setq into use-package and then define the functions all before (or in the config?)
...
*** TODO citar-org-roam
TODO write this org roam integration
