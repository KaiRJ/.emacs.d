...
Corfu uses child frames to display candidate which, because of the current Pop OS (COSMIC DE) autotiling, makes Corfu unusable for me. I am using [[https://company-mode.github.io/][company]] to replace the child frames with popups. Hopefully I can find a fix for this later.
