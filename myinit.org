...
* TODO Org packages
TODO need to have a think of the best way to organise all these packages

This section...

First I'm defining some directories that I use for all my Org files.
...
#+begin_src emacs-lisp
  ;; TODO move this to citar as its really with that part of the work flow
...
** TODO Org-roam
TODO just go over code and give a tidy
